...
#The History Log is a Global List that will keep track of every action done within the CryptoCurrency App.
HistoryList = []
...
def ammendingCrypto():
    ...
    if selection == 1:
                ...
                print ("Amended Name of "+ str([choice][1])+ " with " + str(newName))
                HistoryList.append("Amended Buy inPrice of "+ str([choice][1])+ " with " + str(newName))
    if selection == 2:
                newMC=input('(2) Enter new Market Cap of Crypto     :')
                newData[choice][2] = newMC
                print ("Amended Buy inPrice of "+ str([choice][1])+ " with " + str(newBIP))
                HistoryList.append("Amended Buy inPrice of "+ str([choice][1])+ " with " + str(newBIP))
    if selection == 3:
                newQB=input('(3) Enter new Quatity Bought of Crypto     :')
                newData[choice][3] = newQB
                print ("Amended Quality Bought of "+ str([choice][1])+ " with " + str(newQB))
                HistoryList.append("Amended Quality Bought of "+ str([choice][1])+ " with " + str(newQB))
    if selection == 4:
    ...
    if selection == 5:
                ...
                print ("Amended Buy inPrice of "+ str([choice][1])+ " with " + str(newMP))
                HistoryList.append("Amended Market Price of "+ str([choice][1])+ " with " + str(newMP))
...
def removeCrypto():
    ...
    option = option -1
    print ("Removed", [option], "From CryptoCurrency List.")
    HistoryLog.append["(Removed", str([option]), "From CryptoCurrency List.)"]
    del newData[option]
...
#This 7th Function is custom made by: Rushaun
def HistoryLog():
    print ("-"*50)
